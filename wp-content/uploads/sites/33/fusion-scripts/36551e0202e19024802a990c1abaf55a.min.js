...
var fusionLightboxVars={"status_lightbox":"1","lightbox_gallery":"1","lightbox_skin":"metro-white","lightbox_title":"1","lightbox_arrows":"1","lightbox_slideshow_speed":"5000","lightbox_autoplay":"","lightbox_opacity":"0.9","lightbox_desc":"1","lightbox_social":"1","lightbox_social_links":{"facebook":{"source":"https:\/\/www.facebook.com\/sharer.php?u={URL}","text":"#!trpst#trp-gettext data-trpgettextoriginal=269#!trpen#Share on Facebook#!trpst#\/trp-gettext#!trpen#"},"twitter":{"source":"https:\/\/twitter.com\/share?url={URL}","text":"#!trpst#trp-gettext data-trpgettextoriginal=269#!trpen#Share on Twitter#!trpst#\/trp-gettext#!trpen#"},"reddit":{"source":"https:\/\/reddit.com\/submit?url={URL}","text":"#!trpst#trp-gettext data-trpgettextoriginal=269#!trpen#Share on Reddit#!trpst#\/trp-gettext#!trpen#"},"tumblr":{"source":"https:\/\/www.tumblr.com\/share\/link?url={URL}","text":"#!trpst#trp-gettext data-trpgettextoriginal=269#!trpen#Share on Tumblr#!trpst#\/trp-gettext#!trpen#"},"mail":{"source":"mailto:?body={URL}","text":"#!trpst#trp-gettext data-trpgettextoriginal=270#!trpen#Share by Email#!trpst#\/trp-gettext#!trpen#"}},"lightbox_deeplinking":"1","lightbox_path":"vertical","lightbox_post_images":"1","lightbox_animation_speed":"normal","l10n":{"close":"#!trpst#trp-gettext data-trpgettextoriginal=271#!trpen#Nh\u1ea5n Esc \u0111\u1ec3 \u0111\u00f3ng#!trpst#\/trp-gettext#!trpen#","enterFullscreen":"#!trpst#trp-gettext data-trpgettextoriginal=272#!trpen#V\u00e0o To\u00e0n m\u00e0n h\u00ecnh (Shift + Enter)#!trpst#\/trp-gettext#!trpen#","exitFullscreen":"#!trpst#trp-gettext data-trpgettextoriginal=273#!trpen#Tho\u00e1t ch\u1ebf \u0111\u1ed9 to\u00e0n m\u00e0n h\u00ecnh (Shift + Enter)#!trpst#\/trp-gettext#!trpen#","slideShow":"#!trpst#trp-gettext data-trpgettextoriginal=274#!trpen#tr\u00ecnh chi\u1ebfu#!trpst#\/trp-gettext#!trpen#","next":"#!trpst#trp-gettext data-trpgettextoriginal=216#!trpen#Ti\u1ebfp theo#!trpst#\/trp-gettext#!trpen#","previous":"#!trpst#trp-gettext data-trpgettextoriginal=215#!trpen#Tr\u01b0\u1edbc#!trpst#\/trp-gettext#!trpen#"}};var fusionVideoVars={"status_vimeo":"1"};jQuery(document).ready(function(){jQuery(".fusion-video").each(function(){!jQuery(this).parents(".fusion-modal").length&&1==jQuery(this).data("autoplay")&&jQuery(this).is(":visible")&&jQuery(this).find("iframe").each(function(){jQuery(this).attr("src",jQuery(this).attr("src").replace("autoplay=0","autoplay=1"))})}),jQuery(window).on("resize",function(){var e,i=document.querySelectorAll("iframe"),o=i.length;if(jQuery(".fusion-youtube").each(function(){jQuery(this).is(":visible")||jQuery(this).parents(".fusion-modal").length&&!jQuery(this).parents(".fusion-modal").is(":visible")||jQuery(this).find("iframe").each(function(){this.contentWindow.postMessage('{"event":"command","func":"pauseVideo","args":""}',"*")})}),"undefined"!=typeof Vimeo)for(e=0;e<o;e++)!(void 0!==i[e].src&&-1<i[e].src.toLowerCase().indexOf("vimeo"))||jQuery(i[e]).is(":visible")||jQuery(i[e]).data("privacy-src")&&jQuery(i[e]).hasClass("fusion-hidden")||jQuery(i[e]).parents(".fusion-modal").length&&!jQuery(i[e]).parents(".fusion-modal").is(":visible")||new Vimeo.Player(i[e]).pause()}),jQuery(window).on("fusion-element-render-fusion_youtube fusion-element-render-fusion_vimeo",function(e,i){(void 0!==i?jQuery('div[data-cid="'+i+'"]'):jQuery("body")).find(".full-video, .video-shortcode, .wooslider .slide-content").fitVids()})}),jQuery(window).on("fusion-dynamic-content-render",function(e,i){var o=jQuery(i).find(".fusion-youtube").find("iframe");0<o.length&&o.each(function(){var e;1!==jQuery(this).closest(".fusion-video").data("autoplay")&&"true"!==jQuery(this).closest(".fusion-video").data("autoplay")||(jQuery(this).closest(".fusion-video").data("autoplay","false"),e="playVideo",this.contentWindow.postMessage('{"event":"command","func":"'+e+'","args":""}',"*"))}),0<(o=jQuery(i).find(".fusion-vimeo").find("iframe")).length&&o.each(function(){1!==jQuery(this).closest(".fusion-video").data("autoplay")&&"true"!==jQuery(this).closest(".fusion-video").data("autoplay")||(jQuery(this).closest(".fusion-video").data("autoplay","false"),new Vimeo.Player(jQuery(this)[0]).play())})});
